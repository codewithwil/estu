const portfolioData = [
  ...
  {
    id: 4,
    title: "Rangka Kuat Construction Expo",
    category: "Exhibition",
    type: "exhibition",
    image: "assets/images/portofolio/long/3.png",
    alt: "Rangka Kuat construction product exhibition event",
    description:
      "A construction industry exhibition featuring innovative building materials and structural solutions from Rangka Kuat. The event included product displays, exhibition booths, and networking opportunities with contractors and industry professionals.",
    date: "October 2025",
  ...
  {
    id: 5,
    title: "Rangka Kuat Exhibition Booth",
    category: "Exhibition",
    type: "exhibition",
    image: "assets/images/portofolio/wide/4.png",
    alt: "Rangka Kuat exhibition booth at construction industry event",
    description:
      "An interactive exhibition booth showcasing Rangka Kuat's innovative steel structure and building material solutions. The booth was designed to attract visitors and enhance brand visibility during a large-scale construction exhibition.",
    date: "October 2025",
    location: "Jakarta International Expo",
    guests: "2,500 visitors",
    services: "Booth Exhibition Design, Brand Activation, Event Production",
    tags: [
      "Exhibition Booth",
      "Construction Expo",
      "Brand Activation",
  ...
  {
    id: 6,
    title: "Rangka Kuat Construction Seminar",
    category: "Exhibition",
    type: "exhibition",
    image: "assets/images/portofolio/long/5.png",
    alt: "Construction industry seminar organized by Rangka Kuat",
    description:
      "A professional seminar focused on the latest developments in construction materials and structural technology. Industry experts shared insights while participants engaged in discussions and networking sessions.",
    date: "October 2025",
    location: "Pullman Hotel Jakarta",
    guests: "150 participants",
    services: "Seminar Event Management, Conference Setup, Documentation",
    tags: ["Seminar", "Construction Industry", "Rangka Kuat", "Business Event"],
  },
  {
    id: 7,
    title: "Rangka Kuat Business Gathering",
    category: "Exhibition",
    type: "exhibition",
    image: "assets/images/portofolio/long/6.png",
    alt: "Rangka Kuat corporate business gathering event",
    description:
      "A corporate gathering event bringing together Rangka Kuat executives, partners, and key clients. The event featured company presentations, networking sessions, and entertainment to strengthen business relationships.",
    date: "October 2025",
    location: "Grand Hyatt Jakarta",
    guests: "120 executives",
    services: "Corporate Gathering, Event Coordination, Entertainment",
    tags: [
      "Business Gathering",
      "Corporate Event",
      "Rangka Kuat",
